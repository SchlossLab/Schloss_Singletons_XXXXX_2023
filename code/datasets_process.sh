...
mv $DATA/data.trim.contigs.good.unique.good.filter.unique.precluster.pick.pick.fasta $DATA/data.fasta
mv $DATA/data.trim.contigs.good.unique.good.filter.unique.precluster.denovo.uchime.pick.pick.count_table $DATA/data.count_table
mv $DATA/data.trim.contigs.good.unique.good.filter.unique.precluster.pick.pds.wang.pick.taxonomy $DATA/data.taxonomy
