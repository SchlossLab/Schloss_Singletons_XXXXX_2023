...
Datasets were selected because they sequenced the V4 region of the 16S rRNA gene using Illumina's MiSeq platform using the v2 chemistry with paired 250 nt reads. I identified 12 datasets that satisfied these criteria and downloaded the data directly from the SRA (Table 1 and Figure S1).

* Used the mothur pipeline to
  - Assembly of paired 250 nt reads
*
